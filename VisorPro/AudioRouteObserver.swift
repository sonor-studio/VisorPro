...
class AudioRouteObserver {
    ...
    private func updateCurrentDeviceAndListen() {
        ...
        if currentDeviceID != 0 {
            ...
            AudioHardwareServiceRemovePropertyListener(currentDeviceID, &virtualAddr, virtualVolumeListenerCallback, Unmanaged.passUnretained(self).toOpaque())
        }
        ...
        if currentDeviceID != 0 {
            ...
            AudioHardwareServiceAddPropertyListener(currentDeviceID, &virtualAddr, virtualVolumeListenerCallback, Unmanaged.passUnretained(self).toOpaque())
        }
    }
