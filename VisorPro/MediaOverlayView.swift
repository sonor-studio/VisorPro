...
struct MediaOverlayView: View {
    ...
    var body: some View {
        ...
        let expandedHeight = height + listHeight + 4
        let currentHeight = isStretch && isExpanded ? expandedHeight : height
        let currentTrackHeight = isStretch && isExpanded ? expandedHeight - (trackPadding * 2) : trackHeight
        ...
        ZStack(alignment: .top) {
            ...
            // Nie chcemy żeby kliknięcie w ikonki blokowało gesture na ZStacku powyżej. Ale Gesture jest przypięty do ZStack. ContentShape.
            ...
            .padding(.top, isExpanded ? height + 4 : height)
            .clipped()
