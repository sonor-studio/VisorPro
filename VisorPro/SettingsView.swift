...
struct GeneralSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                Picker("Overlay Expansion Style", selection: $overlayExpansionStyle) {
                    Text("Drawer (Bottom expands only)").tag("drawer")
                    Text("Stretch (Whole pill stretches)").tag("stretch")
                }
                Text("Changes how Volume and Media overlays expand. Battery overlay always uses the Drawer style.")
                    .font(.caption)
                    .foregroundColor(.secondary)
            } header: {
                Text("Appearance")
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(spacing: 0) {
                        CustomSettingsRow(icon: "paintpalette.fill", iconColor: .orange, title: "Fill Center", subtitle: "Fills the inside of the overlay with orange color instead of just the border") {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 0) {
                    CustomSettingsRow(icon: "power", iconColor: .orange, title: "Enable Privacy Module", subtitle: "When disabled, VisorPro completely ignores Camera and Microphone activity") {
