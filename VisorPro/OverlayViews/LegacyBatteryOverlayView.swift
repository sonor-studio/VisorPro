...
struct LegacyBatteryOverlayView: View {
    ...
    var body: some View {
        ...
        let baseHeight: CGFloat = isFullyCharged ? 56 : 72
        let expandedHeight: CGFloat = 160 + (isWarningMode && !mediaKeyManager.topBatteryConsumers.isEmpty ? CGFloat(mediaKeyManager.topBatteryConsumers.count * 20 + 24) : 0)
